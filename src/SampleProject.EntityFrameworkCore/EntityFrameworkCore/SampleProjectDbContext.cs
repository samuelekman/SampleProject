...
public class SampleProjectDbContext :
    AbpDbContext<SampleProjectDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SampleProjectConsts.DbTablePrefix + "Samples", SampleProjectConsts.DbSchema);
        ...
        //{
        //    b.ToTable(SampleProjectConsts.DbTablePrefix + "YourEntities", SampleProjectConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
    }
